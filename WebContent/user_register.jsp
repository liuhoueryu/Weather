...
<body>
		...
		<form action="UserRegisterServlet" method="post"
			...
			<table align="center">
				...
				<tr>
					<td>头像</td>
					<td><input type="radio" name="photo" value="1.gif" checked />
						<img src="image/photo/1.gif" /> <input type="radio" name="photo"
						value="2.gif" /> <img src="image/photo/2.gif" /> <input
						type="radio" name="photo" value="3.gif" /> <img
						src="image/photo/3.gif" /> <input type="radio" name="photo"
						value="4.gif" /> <img src="image/photo/4.gif" /> <input
						type="radio" name="photo" value="5.gif" /> <img
						src="image/photo/5.gif" /></td>
				</tr>
